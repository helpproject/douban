...
<div class="mws-panel grid_8">
  ...
  <div class="mws-panel-body no-padding">
    <div id="DataTables_Table_1_wrapper" class="dataTables_wrapper" role="grid">
      ...
      <table class="mws-datatable-fn mws-table dataTable" id="DataTables_Table_1" aria-describedby="DataTables_Table_1_info">
        <thead>
          <tr role="row">
            ...
            <th class="sorting" role="columnheader" tabindex="0" aria-controls="DataTables_Table_1" rowspan="1" colspan="1" aria-label="Browser: activate to sort column ascending" style="width: 207px;">作者名</th>
            <th class="sorting" role="columnheader" tabindex="0" aria-controls="DataTables_Table_1" rowspan="1" colspan="1" aria-label="Platform(s): activate to sort column ascending" style="width: 195px;">作者简介</th>
        ...
        @foreach($authors as $k=>$v)
          <tr class="@if($k%2==0) even @else odd @endif">
            ...
            <td class=" "><a class="btn btn-info" href="/admin/author/edit?id={{$v->id}}">修改</a>
            <a class="btn btn-danger" href="/admin/author/delete?id={{$v->id}}">删除</a></td>
           </tr>
        @endforeach
        </tbody>
      </table>
      ...
      <div id="pages">
			{!! $authors->appends($request->all())->render() !!}			
		</div>
      </div>
