...
<div class="mws-panel grid_8">
    ...
    <div class="mws-panel-body no-padding">
        ...
        @endif
        <form action="/admin/cate/updata" method="post" class="mws-form" enctype="multipart/form-data">
                ...
                <div class="mws-form-row">
                    ...
                    <div class="mws-form-item clearfix">
                        <ul class="mws-form-list inline">
                            <li><input type="radio" name="status" value="1" {{$info->status ? 'checked="checked"' : ''}}> <label>开启</label></li>
