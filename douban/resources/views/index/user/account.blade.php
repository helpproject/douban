        ...
        <div class="site-nav single-nav">
            <div class="site-nav-logo">
                <a href="https://www.douban.com/accounts/">
                    <img src="/index/Picture/lg_account.png" alt="豆瓣">
                </a>
            </div>
        </div>
    </div>
...
<div class="wrapper">
        ...
        <form id="lzform" name="lzform" action="/account" method="post" enctype="multipart/form-data"><div style="display:none;" ><input type="hidden"  value="UPr1"/></div>
            ...
            <table style="clear:both;" align="center" cellpadding="5" >
                <tr>
                    ...
                    <td valign="top">
                        <input name="nickname" type="text" size="15" maxlength="15" value="{{$user->nickname}}"/>
                ...
                <tr><td class="m" valign="top" align="right">城市:</td>
                    <td valign="top">
                        <input name="city" type="text" size="15" maxlength="15" value="{{$user->city}}"/>
                        <br/><br/></td></tr>

                <tr>
                    <td class="m" align="right">登录邮箱: </td>
                    <td valign="top">
                        <input name="email" type="text" size="15" maxlength="15" value="{{$user->email}}"/>
                    </td>
                </tr>
                ...
                <tr>
                    ...
                    <td valign="top">
                        <input name="phone" type="text" size="15" maxlength="15" value="{{$user->phone}}"/>
                    </td>
                </tr>
            ...
            <div class="group_banned">
                <span class="gact fright">&gt;&nbsp;<a rel="nofollow" href="/suicide">删除帐号</a></span>
            </div>
            ...
            <style type="text/css">
                ...
                .panel .expand { background: url(Images/tongcheng_tab_down.gif) no-repeat right 2px }
                .panel .contract { background: url(Images/tongcheng_tab_up.gif) no-repeat right 2px }
            </style>
    ...
    <div class="aside">
        ...
        去<a href="https://www.douban.com/mine/">我的豆瓣</a>，个人介绍可以直接编辑，邮件提醒位于名号下方的“设置”里
        <br/>
        <br/>
        ...
        个性化域名将用作个人主页网址的一部分，最多15个数字或字母，字母开头，一经设定则不可更改。
        <br/>如果现在你不是非常确定，可以先留空，以后再说。
