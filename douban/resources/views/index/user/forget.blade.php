...
<div class="wrapper">
    ...
    <section id="content"  >
        ...
        <div class="content-wrap" >
                                    ...
                                    <form id="register-form" name="register-form" class="nobottommargin" action="/forget" method="post"  style="margin-top: 150px;margin-left: 230px;">
                                        @if (count($errors) > 0)
                                        ...
                                        <div class="col_full nobottommargin">
                                            {{csrf_field()}}
                                            <button class="button button-3d button-black nomargin" id="register-form-submit" name="register-form-submit" value="register" style="
    cursor: pointer;
    color: #ffffff;
    background: #3fa156;
    ...
    -webkit-border-radius: 3px;">点击发送邮件</button>
                                        </div>
