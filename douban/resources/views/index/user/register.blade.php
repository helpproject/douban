...
<head>
    ...
    <style>
        ...
        .extra-tips .validate-error , .extra-tips .validate-option { padding-left: 10px; background: url(Images/tips_arrow.gif) no-repeat}
        ...
        .captcha-item span.validate-error { padding-left: 10px; background: url(Images/tips_arrow.gif) no-repeat left -52px ; display: none }
    ...
    <script type="text/javascript" src="Scripts/do.js" data-cfg-corelib="https://img3.doubanio.com/f/accounts/c5268df4c1f0bada95cb3d2b80089a50b494b5ee/js/lib/jquery.min.js"></script>
...
<div class="wrapper">
    ...
    <div class="article">
        ...
        <form name="lzform" method="post" action="/register">
            <div style="display:none;">
                <input type="hidden" name="source" value="book"/>
                <input type="hidden" name="redir" value="  "/>
                <img src="/index/Picture/blank.gif" onerror="document.lzform.action='https://accounts.douban.com/register'"/>
            </div>
            ...
            <div class="item extra-tips">
                <label>用户名</label>
                <input  name="username" type="text" class="basic-input" maxlength="60" tabindex="1" value=""/>
            </div>
            ...
            <div class="item extra-tips">
                <label>确认密码</label>
                <input  name="repassword" type="password" class="basic-input" tabindex="2" maxlength="20"/>
            </div>
            <div class="item extra-tips">
                <label>昵称</label>
                <input id="name" name="nickname" type="text"
            ...
            <div class="item">
                <label>&nbsp;</label>
                {{csrf_field()}}
                <input type="submit" value="注册" name="login" class="btn-submit" tabindex="5" style="
    cursor: pointer;
    color: #ffffff;
    background: #3fa156;
...
<span class="fright">
    ...
    · <a href="https://www.douban.com/partner/">豆瓣广告</a>
        ...
        <img src="Picture/blank.gif" style="display:none;" onload="report_ps(true)" onerror="report_ps(false)" />
